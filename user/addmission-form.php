...
if(isset($_POST['submit']))
  {
    ...
    if($upic.size>40){
      alert("Please upload image size less than 40kb");
    }
    
    //geting email id for sending mail after submit the form
        $pid=$_SESSION['uid'];
    ...
    //after form submitted sending email
    $to = $user_email;
    $subject = "Your Application Successfully Submited!";
    $message = "
                <html>
                    <head>
                    ...
                    <body>
                    <h2> Application Form Sumitted! </h2>
                    <p>Your application form successfully submitted!. <br>Soon you got the status of this application via mail or you can also view it from your dashboard.</p> 
                ";
    ...
    // More headers
    $headers .= 'From: <shruthichitti24@gmail.com>' . "\r\n";
...
<select class="form-control white_bg" id="college" name="collegename"  required>
