...
// allowed extensions
$allowed_extensions = array("jpg","jpeg",".pdf",".PDF","docx",".doc");
// Validation for allowed extensions .in_array() function searches an array for a specific value.
if(!in_array($extensiontc,$allowed_extensions))
{
echo "<script>alert('Invalid format. Only jpg / doc / jpeg /pdf format allowed');</script>";
}
...
<div class="col-xl-6 col-lg-12">
 <fieldset>
  <h5>Transfer Certificate(TC)<span style="color:red">*</span></h5>
...
<div class="col-xl-6 col-lg-12">
 <fieldset>
  <h5>10th Marksheet<span style="color:red">*</span>                  </h5>
   <div class="form-group">
...
<div class="col-xl-6 col-lg-12">
 <fieldset>
  <h5>12th Mark Sheet <span style="color:red">*</span>                 </h5>
   <div class="form-group">
