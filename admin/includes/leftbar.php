...
<li class=" nav-item"><a href="#"><i class="la la-file"></i><span class="menu-title" data-i18n="nav.footers.main">Course</span></a>
        ...
        <li class=" nav-item"><a href="#"><i class="la la-building"></i><span class="menu-title" data-i18n="nav.footers.main">College List</span></a>
          <ul class="menu-content">
            <li><a class="menu-item" href="add-college.php" data-i18n="nav.footers.footer_light">Add College</a>
            </li>
            <li><a class="menu-item" href="manage-college.php" data-i18n="nav.footers.footer_dark">Manage College</a>
            </li>
